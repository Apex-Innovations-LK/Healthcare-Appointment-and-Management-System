        ...
        <div class="grid">
            <div class="col-12">
                <div class="card mb-0">
                    ...
                    <p class="text-secondary text-lg mb-5">Welcome to the healthcare analytics platform. Monitor patient risk factors, health metrics, and key performance indicators.</p>
