...
@Component({
    ...
    template: `
        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden m-20 md:m-10">
        ...
        this.authService.registerUser(this.user).subscribe({
            next: (data) => {
                ...
                this.messageService.add({
                    severity: 'success',
                    summary: 'Success',
                    detail: data.message || 'Signup successful!'
                });
