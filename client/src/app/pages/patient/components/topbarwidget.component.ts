...
@Component({
    ...
    imports: [CommonModule, MenubarModule, RouterModule, StyleClassModule, ButtonModule, RippleModule, AppFloatingConfigurator, ToastModule, ConfirmDialogModule],
    ...
    ></p-confirmDialog>
        ...
        <a class="flex items-center" href="/patient">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">MediCare</span>
        </a>
