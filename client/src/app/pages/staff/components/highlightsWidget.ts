...
@Component({
    selector: 'staff-highlights-widget',
    template: `
        <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
            <div class="text-center">
                <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Your Schedule</div>
                <span class="text-muted-color text-2xl">Easily view, manage, and track schedule.</span>
            </div>
            ...
            <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-10">
                <div class="flex justify-center items-center col-span-12 lg:col-span-6 bg-white p-0 order-1 lg:order-none rounded-lg overflow-hidden dark:bg-gray-900">
                    <img src="assets/images/Staff_schedule.png" class="w-full h-auto object-contain" alt="Book appointments" />
                </div>
                ...
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                    ...
                    <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">View Schedule</div>
                    <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"> View your weekly schedule and manage to it easily. </span>
                </div>
            </div>
<!-- 
