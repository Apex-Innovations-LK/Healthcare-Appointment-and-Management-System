...
@Component({
    ...
    template: `
        <div class="landing-page" [ngClass]="{ 'dark-theme': isDarkMode }">
            <header>
                <div class="logo">
                    <h1>MediCare<span class="plus">+</span></h1>
                </div>
                <div class="header-actions">
                  
                    <button pButton label="Login" icon="pi pi-sign-in" (click)="goToLogin()"></button>
                </div>
            </header>
            ...
            <section class="hero">
                <div class="hero-content">
                    ...
                    <h2>Streamlined appointments for patients and providers</h2>
                    <p>Our comprehensive system connects patients with healthcare providers efficiently, saving time and improving care.</p>
                ...
                <div class="hero-image">
                    <img src="assets/images/hero-image.svg" alt="Healthcare illustration" />
                </div>
            </section>
            ...
            <footer>
                <div class="footer-content">
                    <div class="footer-logo">
                        <h2>MediCare<span class="plus">+</span></h2>
                    ...
                    <div class="footer-links">
                        ...
                        <div class="link-group">
                            <h3>Users</h3>
                            <ul>
                                <li><a href="#" (click)="goToLogin()">Patient Portal</a></li>
                                <li><a href="#" (click)="goToLogin()">Doctor Login</a></li>
                                <li><a href="#" (click)="goToLogin()">Admin Dashboard</a></li>
                            </ul>
                        </div>
                        <div class="link-group">
                            <h3>Legal</h3>
                ...
                <div class="copyright">
                    <p>&copy; {{ currentYear }} MediCare+ Healthcare System. All rights reserved.</p>
                </div>
            </footer>
        </div>
    `,
